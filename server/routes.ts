  ...
  app.post("/api/email/send-bulk", async (req, res) => {
    try {
      const { 
        ...
        content,
        template, 
        fromEmail = 'marketing@argilette.com', 
      ...
      },
      {
        ...
        htmlContent: `
          <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; padding: 20px;">
            ...
            <p style="color: #666; line-height: 1.6;">
              Let me know if you have any questions! Reply to this email or <a href="mailto:support@argilette.com" style="color: #3498db;">contact our support team</a>.
            </p>
            <p style="color: #666; line-height: 1.6;">
              Best regards,<br>
              Your ARGILETTE Team
...
Let me know if you have any questions! Contact support: support@argilette.com
    ...
    res.send(`
      ...
      <body>
        <div class="container">
          ...
          <p><a href="mailto:support@argilette.com">Contact support</a> if you have any questions.</p>
        </div>
      </body>
      </html>
    `);
